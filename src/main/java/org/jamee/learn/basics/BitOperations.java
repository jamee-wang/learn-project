...
public class BitOperations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("101 | 110 = " + (5 | 6));
        System.out.println("101 ^ 110 = " + (5 ^ 6));
        // 负数是用补码表示的，因此 -6 二进制为：11111111111111111111111111111010，
        // 原码 = 补码 - 1 取反，即：10000000000000000000000000000110
        System.out.println("-6 = " + Integer.toBinaryString(-6)); // 11111111111111111111111111111010
        // >> 符号位移走后，高位补原符号位，>>> 高位补零
        System.out.println("-6 >> 1 = " + (-6 >> 1)); // 11111111111111111111111111111101 原码：10000000000000000000000000000011
        System.out.println("-6 >>> 1 = " + (-6 >>> 1)); // 01111111111111111111111111111101
        System.out.println("6>>>1 = " + (6 >>> 1));
        System.out.println("6 << 1 = " + (6 << 1));
        // << 溢出截断，低位补零，负数是用补码表示的，参考上面的二进制，因此移位结果为：11111111111111111111111111110100
        // 原码：10000000000000000000000000001100 = -12
        System.out.println("-6 << 1 = " + (-6 << 1));
        ...
        // System.out.println("6<<<1 = " + (6<<<1));
        // 00000000000000000000000000000110 -> 11111111111111111111111111111001
        // 原码: 10000000000000000000000000000111
        System.out.println("~6 = " + ~6);
        // 11111111111111111111111111111010 -> 00000000000000000000000000000101
        System.out.println("~-6 = " + ~-6);
